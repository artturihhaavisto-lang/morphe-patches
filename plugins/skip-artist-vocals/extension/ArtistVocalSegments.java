 ...
 * <ol>
 *   <li>Find the track's YouTube video ID <b>or</b> use
 ...
 * <h3>Example</h3>
 * <pre>{@code
 * // Skip sexmane's verse from 1:02–1:47 and his outro from 3:10–3:35
 * SEGMENTS.put("dQw4w9WgXcQ", new long[][]{
 *     {mins(1, 2), mins(1, 47)},
 *     {mins(3, 10), mins(3, 35)},
 * });
 *
 * // Same track keyed by artist|title (fallback when media ID is unavailable)
...
public final class ArtistVocalSegments {
    ...
    static {
        ...
        //
        // Helpers:
        //   mins(m, s)  ->  milliseconds   e.g. mins(1, 30) = 90000
        //   secs(s)     ->  milliseconds   e.g. secs(45)    = 45000
        // =====================================================================
